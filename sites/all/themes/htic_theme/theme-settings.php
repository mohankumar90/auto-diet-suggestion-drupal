 ...
 */
function htic_theme_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['htic_theme_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('htic_theme sample setting'),
  '#default_value' => theme_get_setting('htic_theme_example'),
